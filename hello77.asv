function [pchmean,contSet2,contTs2]=hello77(contourSet,pitchstd,contms,contTs,vibrato,nFrame)
...
% end
% 
% [~,I]=max(salience,[],2);   %max element of every row,corresponding to a Frame
% 
% Id=[(1:nFrame)' I];
